...
def breakup_text_into_chunks(
    text: str, max_tokens: int = 2000, overlap_size: int = 0, encoding: str = "gpt2"
):
    ...
    def breakup_tokens(tokens, max_tokens, overlap_size):
        ...
        if len(tokens) <= max_tokens:
            ...
            yield from breakup_tokens(
                tokens[max_tokens - overlap_size :], max_tokens, overlap_size
            )
